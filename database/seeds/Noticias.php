    ...
    */
    public function run(){
        ...
        foreach ($database as $db) {
            # code...
           /*Papeis*/DB::connection($db)->table('noticias')->insert([
            'titulo' => 'Papéis',
            'idpessoa' => '1',
           ...
           /*Plastico*/DB::connection($db)->table('noticias')->insert([
            'titulo' => 'Plásticos',
            'idpessoa' => '1',
           ...
           /*Vidros*/DB::connection($db)->table('noticias')->insert([
            'titulo' => 'Vidros',
            'idpessoa' => '1',
           ...
           /*Metais*/DB::connection($db)->table('noticias')->insert([
            'titulo' => 'Metais',
            'idpessoa' => '1',
           ...
           /*Isopor*/DB::connection($db)->table('noticias')->insert([
            'titulo' => 'Isopor',
            'idpessoa' => '1',
