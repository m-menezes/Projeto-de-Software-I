...
Route::group(['middleware' => 'auth'], function(){
	...
	Route::get('/produto/view/{id}',	 		['as' => 'view_produto', 		'uses' => 'SmartRecycleController@view_produto']);
	...
	Route::get('/busca',	 					['as' => 'busca_produto', 		'uses' => 'SmartRecycleController@busca_produto']);
});
