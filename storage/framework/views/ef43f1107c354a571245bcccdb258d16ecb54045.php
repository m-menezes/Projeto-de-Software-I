<div class="row h-100">
	<div class="container" id="text-topo">
		<?php if(!Auth::check() && !Auth::guard('org')->check()): ?>
		...
		<?php else: ?>
		<div class="typewriter">
			<h2 class="typewrite weight-300" data-period="2000" data-type='[ "Para proteger o futuro do planeta e conservalo para as proximas gerações...", "precisamos reciclar para enconomizar energia e recursos naturais." ]'>
				<span class="wrap"></span>
			</h2>
		</div>
		<?php endif; ?>
