...
<div class="container" style="text-indent: 4%; line-height: 35px;">
	<div class="m-4 mt-5 text-justify">
		<div class="row">
			<p>O projeto <strong><i>{{ucfirst(config('app.name'))}}</i></strong> tem como objetivo principal otimizar e gerenciar a da coleta de materiais recicláveis, facilitando o contato entre entidades de recebimento e interessados.</p>
		</div>
		<div class="row">
			<p>
